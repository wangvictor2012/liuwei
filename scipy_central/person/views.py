        ...
        if form.is_valid():
            ...
            if previous_email:
                ...
                message = render_to_string(\
                              ...
                              ctx_dict)
                send_email((previous_email,), ("IFB's Publication: change of "
...
def profile_page(request, slug=None, user_id=None):
    ...
    if the_user == request.user:
        no_entries = 'You have not submitted any entries to IFB Publications.'
    else:
        no_entries = 'This user has not submitted any entries to IFB Publications.'
