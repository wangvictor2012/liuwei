...
INSTALLED_APPS = (
	...
	# django-paypal ipn module plugin
	'paypal.standard.ipn',
)
#HAYSTACK_SITECONF = 'SciPyCentral.search_sites'



PAYPAL_RECEIVER_EMAIL = "yassine@abgenomica.com"
...
SPC = {
    ...
    'short_URL_root': 'http://192.54.201.180/',
...
try:
    ...
    SERVER_EMAIL = 'wei.liu@agroparistech.fr'
